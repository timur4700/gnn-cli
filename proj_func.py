...
from proj import func as func_proj
import mol_utils
import graph_prep
import graph_config
...
def make(prj_name, args):
            #if prj_name in state.LOG:
            #    raise FileExistsError(color_font(f'The project with the name ({prj_name}) already exists.\nPlease choose another name or select existing project with the command <choose>.',
            #                                            'red'))
